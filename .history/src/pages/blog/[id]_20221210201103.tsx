...
import { BlogPage_Props, GetStaticProps_Params } from "src/types/page-type";
const BlogPage: NextPageWithLayout<BlogPage_Props> = ({
  blog,
  tocHeadings,
}) => {
  return (
    <>
      ...
      <BlogContent blog={blog} tocHeadings={tocHeadings} />
    </>
  );
};
