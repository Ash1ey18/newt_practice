...
import { AreaHome_Props, GetStaticProps_Params } from "src/types/page-type";
const AreaHome: NextPageWithLayout<AreaHome_Props> = ({ areaBlogs, areas }) => {
